...
//            }
    ...
    public void insertContact(ContentValues pValues, long pRawContactId, ContentResolver pResolver) {
        //往data表里写入姓名数据
        pValues.clear();
        pValues.put(ContactsContract.Contacts.Data.RAW_CONTACT_ID, pRawContactId);
        pValues.put(ContactsContract.Contacts.Data.MIMETYPE, ContactsContract.CommonDataKinds.StructuredName.CONTENT_ITEM_TYPE); //内容类型
        pValues.put(ContactsContract.CommonDataKinds.StructuredName.GIVEN_NAME, "随便");
        pResolver.insert(ContactsContract.Data.CONTENT_URI, pValues);

        //往data表里写入电话数据
        pValues.clear();
        pValues.put(ContactsContract.Contacts.Data.RAW_CONTACT_ID, pRawContactId);
        pValues.put(ContactsContract.Contacts.Data.MIMETYPE, ContactsContract.CommonDataKinds.Phone.CONTENT_ITEM_TYPE);
        pValues.put(ContactsContract.CommonDataKinds.Phone.NUMBER, "13921009789");
        pValues.put(ContactsContract.CommonDataKinds.Phone.TYPE, ContactsContract.CommonDataKinds.Phone.TYPE_MOBILE);
        pResolver.insert(ContactsContract.Data.CONTENT_URI, pValues);
    }
}
